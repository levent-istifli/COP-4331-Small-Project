<?php
    ...
    if($conn->connect_error) {
        ...
        $required = ["userid", "firstname", "lastname", "phonenumber", "email", "id"];
        ...
        $stmt->bind_param("ssssii", $in_data["firstname"], $in_data["lastname"], $in_data["phonenumber"], $in_data["email"], $in_data["id"], $in_data["userid"]);
