<?php
    ...
    // This file is required to access the database. In it are sensitive
    // database information, including the host's ip address, the user, 
    // the database password, and database name
    ...
    // checks if conection is successful. returns error message or 
